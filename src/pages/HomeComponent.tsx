...
function HomeComponent() {
  ...
  const containerStyle:CSSProperties = {
    ...
    background:
      "linear-gradient(to right, rgba(131, 164, 212, 0.5), rgba(182, 251, 255, 0.1))",
    ...
    <>
      <div className="flex-item">
        ...
        <div style={containerStyle}>
          ...
          <div style={textStyle}>
            <p>
              Here's some text about the app. Maybe a quick guide or an overview
              of features.
            </p>
            <p>
              Feel free to explore the documentation on the right to get more
              information about the available functionalities.
            </p>
          </div>
        </div>
      </div>
